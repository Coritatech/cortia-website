        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6 mb-50">
                    <div class="tp-footer-widget footer-cols-1 wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                ...
                <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6 mb-50 ">
                    <div class="tp-footer-widget footer-cols-2 pl-55 tp-footer-widget-cutm-pdg-2 wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-footer-copy-right text-center wow fadeInUp">
                        <p class="tp-footer-copy-paragraph">Full Copyright & Design By @ <a href="#">Cortiatech</a> – <?php echo date('Y') ?></p>
                    </div>
                </div>
            </div>
        </div>
