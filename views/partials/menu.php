...
<div class="tpoffcanvas-area">
    <div class="tpoffcanvas">
        ...
        <div class="tpoffcanvas__title">
            <p>Cortia is the partner of choice for many of the world’s leading enterprises. We help businesses
                development.</p>
        </div>
                ...
                <div class="tp-header-3-wrapper p-relative">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-6 col-md-5 col-6">
                            <div class="logo">
                                <a href="/">
                                    <img src="views/assets/img/logo/logo<?php echo $url == '/' ? '3' : ''; ?>.png"
                                        alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-7 d-none d-xl-block">
                            <div
                                class="main-menu main-menu-<?php echo $url == '/' ? '3' : '2'; ?> main-mega-menu text-center">
                        ...
                        <div class="col-xl-3 col-lg-8 col-md-6 col-6">
                            <div class="tp-header-right d-flex justify-content-end align-items-center">
                                ...
                                <div class="tp-header-button">
                                    <a class="tp-header-<?php echo $url == '/' ? 'btn' : 'btn2'; ?> tp-header-btn-<?php echo $url == '/' ? 'white' : 'white2'; ?> d-none d-md-block"
                                        rel="noreferrer" href="/contact" target="_blank"><span>Get a Quete</span></a>
                                </div>
