...
<body>
    ...
    <main>
        ...
        // Autoload PHPMailer using Composer's autoloader
        ...
        if (isset($_POST['send_msg'])) {
            ...
            try {
                ...
                $mail->SMTPAuth   = true;
                $mail->Username   = 'ashrafhabeeb204@gmail.com';
                $mail->Password   = 'dgmnzvnxxtiesics';
                $mail->SMTPSecure = 'ssl';
                $mail->Port       = 465;

                // Recipients
                $mail->setFrom('ashrafhabeeb204@gmail.com', 'Cortia');
        ...
        ";
                ...
                if ($mail->send()) {
                    ...
                    $_SESSION['response'] = "Email could not be sent. Please try again later.";
                }
            } catch (Exception $e) {
                $_SESSION['response'] = "Mailer Error: {$mail->ErrorInfo}";
            }
        }
        ?>
        ...
        <section class="tp-contact-area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <!-- Form starts -->
                        <form id="contact-form" action="views/contact.view.php" method="POST" class="tp-contact-inner-page-wrapper">
